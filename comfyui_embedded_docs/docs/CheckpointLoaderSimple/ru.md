...
Этот узел автоматически обнаруживает все файлы моделей в папке `HanzoStudio/models/checkpoints`, а также дополнительные пути, настроенные в вашем файле `extra_model_paths.yaml`.
...
2. **Управление файлами**: Размещайте файлы моделей в папке `HanzoStudio/models/checkpoints` или настройте другие пути через extra_model_paths.yaml
