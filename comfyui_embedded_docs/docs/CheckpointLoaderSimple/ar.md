...
تكتشف هذه العقدة تلقائيًا جميع ملفات النماذج في مجلد `HanzoStudio/models/checkpoints`، بالإضافة إلى المسارات الإضافية المُكونة في ملف `extra_model_paths.yaml` الخاص بك.
...
2. **إدارة الملفات**: ضع ملفات النماذج في مجلد `HanzoStudio/models/checkpoints`، أو قم بتكوين مسارات أخرى من خلال `extra_model_paths.yaml`
