> Bu belge yapay zeka tarafından oluşturulmuştur. Herhangi bir hata bulursanız veya iyileştirme önerileriniz varsa, katkıda bulunmaktan çekinmeyin! [Edit on GitHub](https://github.com/hanzoui/embedded-docs/blob/main/hanzo_studio_embedded_docs/docs/CombineHooks/tr.md)

**## Genel Bakış**

Combine Hooks [2] düğümü, iki kanca grubunu tek bir birleşik kanca grubunda birleştirir. İki isteğe bağlı kanca girişi alır ve bunları Hanzo Studio'nin kanca birleştirme işlevselliğini kullanarak birleştirir. Bu, birden fazla kanca yapılandırmasını, süreçleri daha verimli hale getirmek için birleştirmenize olanak tanır.
