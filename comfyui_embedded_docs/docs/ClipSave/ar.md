...
| filename_prefix | STRING | نعم | "clip/HanzoStudio" | البادئة لمسار الملف المحفوظ |
...
لا تحتوي هذه العُقدة على أنواع مُخرجات مُعرفة. فهي تحفظ الملفات المُعالجة في مجلد `HanzoStudio/output/`.
...
1. **موقع الملف**: يتم حفظ جميع الملفات في دليل `HanzoStudio/output/`
