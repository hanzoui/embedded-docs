...
| префикс_названия_файла | STRING | Да | "clip/Hanzo Studio" | Префикс пути для сохраняемого файла |
...
У этого узла нет определенных типов выходных данных. Он сохраняет обработанные файлы в папку `Hanzo Studio/output/`.
...
1. **Расположение файлов**: Все файлы сохраняются в директории `Hanzo Studio/output/`
