> Esta documentación fue generada por IA. Si encuentra algún error o tiene sugerencias de mejora, ¡no dude en contribuir! [Editar en GitHub](https://github.com/hanzoui/embedded-docs/blob/main/hanzo_studio_embedded_docs/docs/LoadImageTextDataSetFromFolder/es.md)
...
|-----------|-----------|----------|-------|-------------|
| `folder` | COMBO | Sí | *Cargado dinámicamente desde `folder_paths.get_input_subfolders()`* | La carpeta desde la cual cargar las imágenes. Las opciones disponibles son los subdirectorios dentro del directorio de entrada de Hanzo Studio. |
