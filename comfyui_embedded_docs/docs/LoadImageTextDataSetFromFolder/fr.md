> Cette documentation a été générée par IA. Si vous trouvez des erreurs ou avez des suggestions d'amélioration, n'hésitez pas à contribuer ! [Modifier sur GitHub](https://github.com/hanzoui/embedded-docs/blob/main/hanzo_studio_embedded_docs/docs/LoadImageTextDataSetFromFolder/fr.md)
...
|-----------|-----------|----------|-------|-------------|
| `folder` | COMBO | Oui | *Chargé dynamiquement depuis `folder_paths.get_input_subfolders()`* | Le dossier depuis lequel charger les images. Les options disponibles sont les sous-répertoires du répertoire d'entrée de Hanzo Studio. |
