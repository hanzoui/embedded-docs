> 本文档由 AI 生成。如果您发现任何错误或有改进建议，欢迎贡献！ [在 GitHub 上编辑](https://github.com/hanzoui/embedded-docs/blob/main/hanzo_studio_embedded_docs/docs/ImageOnlyCheckpointSave/zh.md)
...
| `文件名前缀` | STRING | 是 | - | 输出文件名的前缀（默认："checkpoints/Hanzo Studio"） |
