> This documentation was AI-generated. If you find any errors or have suggestions for improvement, please feel free to contribute! [Edit on GitHub](https://github.com/hanzoui/embedded-docs/blob/main/hanzo_studio_embedded_docs/docs/ImageOnlyCheckpointSave/en.md)
...
| `filename_prefix` | STRING | Yes | - | The prefix for the output filename (default: "checkpoints/Hanzo Studio") |
