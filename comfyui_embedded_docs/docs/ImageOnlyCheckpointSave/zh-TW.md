> 本文檔由 AI 生成。如果您發現任何錯誤或有改進建議，歡迎貢獻！ [Edit on GitHub](https://github.com/hanzoui/embedded-docs/blob/main/hanzo_studio_embedded_docs/docs/ImageOnlyCheckpointSave/zh-TW.md)
...
| `檔名前綴` | STRING | 是 | - | 輸出檔案名稱的前綴（預設值："checkpoints/Hanzo Studio"） |
