...
|-----------|-------------|-------------|
| `model`   | MODEL     | Le modèle UNet chargé, qui fait partie du tuple de sortie. Ce modèle est essentiel pour les tâches de synthèse et de manipulation d'images dans le cadre Hanzo Studio. |
