> Esta documentação foi gerada por IA. Se você encontrar erros ou tiver sugestões de melhoria, sinta-se à vontade para contribuir! [Editar no GitHub](https://github.com/hanzoui/embedded-docs/blob/main/hanzo_studio_embedded_docs/docs/SaveVideo/pt-BR.md)

O nó SaveVideo salva o conteúdo de vídeo de entrada no diretório de saída do seu Hanzo Studio. Ele permite que você especifique o prefixo do nome do arquivo, o formato do vídeo e o codec para o arquivo salvo. O nó gerencia automaticamente a nomenclatura dos arquivos com incrementos de contador e pode incluir metadados do fluxo de trabalho no vídeo salvo.
