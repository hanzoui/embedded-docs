> Esta documentação foi gerada por IA. Se você encontrar erros ou tiver sugestões de melhoria, sinta-se à vontade para contribuir! [Editar no GitHub](https://github.com/hanzoui/embedded-docs/blob/main/hanzo_studio_embedded_docs/docs/SaveSVGNode/pt-BR.md)
...
|-------------|-----------|-------------|
| `ui` | DICT | Retorna informações do arquivo, incluindo nome do arquivo, subpasta e tipo, para exibição na interface do Hanzo Studio |
