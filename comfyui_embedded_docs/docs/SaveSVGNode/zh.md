> 本文档由 AI 生成。如果您发现任何错误或有改进建议，欢迎贡献！ [在 GitHub 上编辑](https://github.com/hanzoui/embedded-docs/blob/main/hanzo_studio_embedded_docs/docs/SaveSVGNode/zh.md)
...
| 输出名称 | 数据类型 | 描述 |
|----------|-----------|-------------|
| `ui` | DICT | 返回文件信息，包括文件名、子文件夹和类型，用于在 Hanzo Studio 界面中显示 |
