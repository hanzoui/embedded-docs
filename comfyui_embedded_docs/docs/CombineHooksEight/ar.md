> تم إنشاء هذه الوثيقة بواسطة الذكاء الاصطناعي. إذا وجدت أي أخطاء أو لديك اقتراحات للتحسين، فلا تتردد في المساهمة! [Edit on GitHub](https://github.com/hanzoui/embedded-docs/blob/main/hanzo_studio_embedded_docs/docs/CombineHooksEight/ar.md)

تُدمج عقدة Combine Hooks [8] ما يصل إلى ثماني مجموعات خطاف مختلفة في مجموعة خطاف موحدة واحدة. تأخذ العقدة مدخلات خطاف متعددة وتدمجها باستخدام وظيفة دمج الخطاف في Hanzo Studio. يتيح ذلك دمج تكوينات خطاف متعددة لمعالجة مبسطة في سير العمل المتقدمة.
