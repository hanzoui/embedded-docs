> Esta documentación fue generada por IA. Si encuentra algún error o tiene sugerencias de mejora, ¡no dude en contribuir! [Editar en GitHub](https://github.com/hanzoui/embedded-docs/blob/main/hanzo_studio_embedded_docs/docs/SaveWEBM/es.md)
...
| `prefijo_nombre_archivo` | STRING | No | - | Prefijo para el nombre del archivo de salida (predeterminado: "Hanzo Studio") |
