> 이 문서는 AI에 의해 생성되었습니다. 오류를 발견하거나 개선 제안이 있으시면 기여해 주세요! [GitHub에서 편집](https://github.com/hanzoui/embedded-docs/blob/main/hanzo_studio_embedded_docs/docs/LoraSave/ko.md)
...
|-----------|-----------|----------|-------|-------------|
| `파일명 접두사` | STRING | 예 | - | 출력 파일 이름의 접두사 (기본값: "loras/Hanzo Studio_extracted_lora") |
