...
Currently, the 3D-related nodes in the Hanzo Studio frontend share the same canvas component, so their basic operations are mostly consistent except for some functional differences.
