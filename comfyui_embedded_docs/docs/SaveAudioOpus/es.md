> Esta documentación fue generada por IA. Si encuentra algún error o tiene sugerencias de mejora, ¡no dude en contribuir! [Editar en GitHub](https://github.com/hanzoui/embedded-docs/blob/main/hanzo_studio_embedded_docs/docs/SaveAudioOpus/es.md)
...
| `filename_prefix` | STRING | No | - | El prefijo para el nombre del archivo de salida (por defecto: "audio/Hanzo Studio") |
