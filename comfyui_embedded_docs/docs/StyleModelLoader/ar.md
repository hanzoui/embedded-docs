> تم إنشاء هذه الوثيقة بواسطة الذكاء الاصطناعي. إذا وجدت أي أخطاء أو لديك اقتراحات للتحسين، فلا تتردد في المساهمة! [Edit on GitHub](https://github.com/hanzoui/embedded-docs/blob/main/hanzo_studio_embedded_docs/docs/StyleModelLoader/ar.md)

سيقوم هذه العقدة باكتشاف النماذج الموجودة في مجلد `Hanzo Studio/models/style_models`، كما ستقرأ النماذج من المسارات الإضافية المُكونة في ملف extra_model_paths.yaml. في بعض الأحيان، قد تحتاج إلى **تحديث واجهة Hanzo Studio** للسماح لها بقراءة ملفات النماذج من المجلد المقابل.
