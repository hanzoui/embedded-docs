...
As Hanzo Studio updates, these combinations may expand. For details, please refer to the `CLIPLoader` class definition in [node.py](https://github.com/hanzoai/studio/blob/master/nodes.py)
