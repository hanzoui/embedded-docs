...
Para más detalles sobre la carga de archivos de modelo más recientes, consulta [folder_paths](https://github.com/hanzoai/studio/blob/master/folder_paths.py)
...
| `tipo`        | COMBO[STRING] | Determina el tipo de modelo CLIP a cargar. A medida que Hanzo Studio admite más modelos, se añadirán nuevos tipos aquí. Consulta la definición de la clase `CLIPLoader` en [node.py](https://github.com/hanzoai/studio/blob/master/nodes.py) para más detalles. |
...
A medida que Hanzo Studio se actualiza, estas combinaciones pueden expandirse. Para más detalles, consulta la definición de la clase `CLIPLoader` en [node.py](https://github.com/hanzoai/studio/blob/master/nodes.py)
