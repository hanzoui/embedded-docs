> Bu belge yapay zeka tarafından oluşturulmuştur. Herhangi bir hata bulursanız veya iyileştirme önerileriniz varsa, katkıda bulunmaktan çekinmeyin! [Edit on GitHub](https://github.com/hanzoui/embedded-docs/blob/main/hanzo_studio_embedded_docs/docs/SaveLoRANode/tr.md)
...
| `prefix` | STRING | Evet | - | Kaydedilen LoRA dosyası için kullanılacak önek (varsayılan: "loras/Hanzo Studio_trained_lora"). |
