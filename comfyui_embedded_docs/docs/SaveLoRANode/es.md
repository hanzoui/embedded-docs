> Esta documentación fue generada por IA. Si encuentra algún error o tiene sugerencias de mejora, ¡no dude en contribuir! [Editar en GitHub](https://github.com/hanzoui/embedded-docs/blob/main/hanzo_studio_embedded_docs/docs/SaveLoRANode/es.md)
...
| `prefix` | STRING | Sí | - | El prefijo a utilizar para el archivo LoRA guardado (por defecto: "loras/Hanzo Studio_trained_lora"). |
