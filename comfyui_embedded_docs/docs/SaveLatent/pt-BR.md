> Esta documentação foi gerada por IA. Se você encontrar erros ou tiver sugestões de melhoria, sinta-se à vontade para contribuir! [Editar no GitHub](https://github.com/hanzoui/embedded-docs/blob/main/hanzo_studio_embedded_docs/docs/SaveLatent/pt-BR.md)
...
|-------------|-----------|-------------|
| `ui` | UI | Fornece informações de localização do arquivo para o latente salvo na interface do Hanzo Studio |