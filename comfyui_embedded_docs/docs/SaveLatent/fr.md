> Cette documentation a été générée par IA. Si vous trouvez des erreurs ou avez des suggestions d'amélioration, n'hésitez pas à contribuer ! [Modifier sur GitHub](https://github.com/hanzoui/embedded-docs/blob/main/hanzo_studio_embedded_docs/docs/SaveLatent/fr.md)
...
|-------------|-----------|-------------|
| `ui` | UI | Fournit des informations sur l'emplacement du fichier pour le latent enregistré dans l'interface Hanzo Studio |
