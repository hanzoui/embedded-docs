> Esta documentación fue generada por IA. Si encuentra algún error o tiene sugerencias de mejora, ¡no dude en contribuir! [Editar en GitHub](https://github.com/hanzoui/embedded-docs/blob/main/hanzo_studio_embedded_docs/docs/SaveLatent/es.md)
...
|-------------|-----------|-------------|
| `ui` | UI | Proporciona información de ubicación del archivo para el latente guardado en la interfaz de Hanzo Studio |
