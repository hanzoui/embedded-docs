> تم إنشاء هذه الوثيقة بواسطة الذكاء الاصطناعي. إذا وجدت أي أخطاء أو لديك اقتراحات للتحسين، فلا تتردد في المساهمة! [Edit on GitHub](https://github.com/hanzoui/embedded-docs/blob/main/hanzo_studio_embedded_docs/docs/SaveLatent/ar.md)
...
| `بادئة اسم الملف` | STRING | لا | - | البادئة لاسم ملف الإخراج (الافتراضي: "latents/Hanzo Studio") |
...
|-------------|-----------|-------------|
| `ui` | UI | يوفر معلومات موقع الملف للبيانات الكامنة المحفوظة في واجهة Hanzo Studio |