> 本文檔由 AI 生成。如果您發現任何錯誤或有改進建議，歡迎貢獻！ [Edit on GitHub](https://github.com/hanzoui/embedded-docs/blob/main/hanzo_studio_embedded_docs/docs/Preview3D/zh-TW.md)
...
**3D 節點偏好設定**
部分 3D 節點的相關偏好設定可在 Hanzo Studio 的設定選單中進行配置。請參考以下文件進行相應設定：
...
目前 Hanzo Studio 前端中的 3D 相關節點共用同一個畫布元件，因此除了部分功能差異外，其基本操作大多一致。
