...
**3B Düğüm Tercihleri**
3B düğümlerle ilgili bazı tercihler, Hanzo Studio'nın ayarlar menüsünde yapılandırılabilir. Lütfen ilgili ayarlar için aşağıdaki belgelere başvurun:
...
Şu anda Hanzo Studio ön yüzündeki 3B ile ilgili düğümler aynı tuval bileşenini paylaştığından, bazı işlevsel farklılıklar dışında temel işlemleri büyük ölçüde tutarlıdır.
