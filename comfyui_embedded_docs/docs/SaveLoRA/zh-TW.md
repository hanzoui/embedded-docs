> 本文檔由 AI 生成。如果您發現任何錯誤或有改進建議，歡迎貢獻！ [Edit on GitHub](https://github.com/hanzoui/embedded-docs/blob/main/hanzo_studio_embedded_docs/docs/SaveLoRA/zh-TW.md)
...
| `prefix` | STRING | 是 | N/A | 用於儲存 LoRA 檔案的前綴（預設值："loras/Hanzo Studio_trained_lora"）。 |
