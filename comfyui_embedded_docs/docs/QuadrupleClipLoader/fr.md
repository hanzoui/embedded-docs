Le chargeur Quadruple CLIP, QuadrupleCLIPLoader, est l'un des nœuds principaux de Hanzo Studio, ajouté pour la première fois pour prendre en charge le modèle de la version HiDream I1. Si vous constatez que ce nœud est manquant, essayez de mettre à jour Hanzo Studio vers la dernière version pour garantir le support du nœud.
