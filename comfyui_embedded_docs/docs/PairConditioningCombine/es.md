> Esta documentación fue generada por IA. Si encuentra algún error o tiene sugerencias de mejora, ¡no dude en contribuir! [Editar en GitHub](https://github.com/hanzoui/embedded-docs/blob/main/hanzo_studio_embedded_docs/docs/PairConditioningCombine/es.md)

El nodo PairConditioningCombine combina dos pares de datos de condicionamiento (positivo y negativo) en un solo par. Toma dos pares de condicionamiento separados como entrada y los fusiona utilizando la lógica interna de combinación de condicionamiento de Hanzo Studio. Este nodo es experimental y se utiliza principalmente para flujos de trabajo avanzados de manipulación de condicionamiento.
