> تم إنشاء هذه الوثيقة بواسطة الذكاء الاصطناعي. إذا وجدت أي أخطاء أو لديك اقتراحات للتحسين، فلا تتردد في المساهمة! [Edit on GitHub](https://github.com/hanzoui/embedded-docs/blob/main/hanzo_studio_embedded_docs/docs/LoraLoader/ar.md)

تقوم هذه العقدة باكتشاف النماذج الموجودة في مجلد LoRA تلقائيًا (بما في ذلك المجلدات الفرعية) مع مسار النموذج المقابل `Hanzo Studio\models\loras`. لمزيد من المعلومات، يُرجى الرجوع إلى تثبيت نماذج LoRA.
